...
[_DVORAK] = LAYOUT(
  ...
  KC_LSFT, KC_SCLN, KC_Q,    KC_J,    KC_K,    KC_X, KC_MUTE,     XXXXXXX,KC_B,    KC_M,    KC_W,    KC_V,    KC_Z,  KC_ENT,
 ...
 * |------+------+------+------+------+------|  MUTE |    |       |------+------+------+------+------+------|
 * |Shift |      |  Cut | Copy | Paste|      |-------|    |-------|      | Home |      | End  |      | Enter|
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | LGUI | LAlt | LCTR |LOWER | /Enter  /       \Space \  |RAISE | RCTR | RAlt | RGUI |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
...
static void print_status_narrow(void) {
    ...
    oled_write_P(PSTR("\n\n"), false);
    if (is_caps_word_on()) {
        //oled_dirty = OLED_ALL_BLOCK_MASK;
    ...
    oled_write_ln_P(get_u16_str(get_tapping_term(0, NULL), ' '), false);
}
